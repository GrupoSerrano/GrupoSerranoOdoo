...
class SAT_CatalogosWizard(models.TransientModel):
    _inherit = 'sat.catalogos.wizard'

    catalogo = fields.Selection(selection_add=[
                                ...
                                default="action_sat_tipo_comprobante",
                                ondelete={
    ...
    def open_catalog(self):
        ...
        if 'waybill' in self.catalogo:
            ...
            catalog_return = super(SAT_CatalogosWizard, self).open_catalog()
